...
<body>
	<div class="container card  my-5">
		...
		<form  action="jsp009_result.jsp"  method="post"  onsubmit="return checkScore()">
			<div class="my-3">
				<label for="kor"   class="form-label">KOR : </label>
				<input type="number"  class="form-control"  id="kor"  name="ko"
					   min="0"   max="100"  value="0"
				 />      
			</div><!-- end kor -->
			<div class="my-3">
				<label for="eng"   class="form-label">ENG : </label>
				<input type="number"  class="form-control"  id="eng"  name="en"
					   min="0"   max="100" />      
			</div><!-- end kor -->
			<div class="my-3">
				<label for="math"   class="form-label">MATH : </label>
				<input type="number"  class="form-control"  id="math"  name="ma" 
					   min="0"   max="100"/>      
			</div><!-- end kor -->
