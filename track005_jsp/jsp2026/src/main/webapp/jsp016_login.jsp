...
<body>
	<div class="container card  my-5">
		...
		■ 2. 처리부분: action="jsp016_result.jsp"  / 주소표시창 노출x / 데이터 보관이름: email, bpass
		■ 3. 로그아웃 버튼 클릭시 로그아웃 처리  (로그인시에만 보이기)
		</pre>
		<!-- 로그인시에만 보이기 -->
		...
		<%-- <%
			...
			"<pre  class='alert alert-warning'>"+
	         "반갑습니다.   oo 님"+
	      	"</pre><div class='text-start'>"+
	      	"<a href='jsp016_logout.jsp' class='btn btn-primary'> 로그아웃</a></div>"
	      	);
			}
		 %> --%>
		 <!-- 로그인시에만 보이기 -->
