...
<%@include file="inc/header.jsp" %>
    ...
    <div class="container my-5">
		...
		%>
        <form  action ="edit_action.jsp"  method="post"   onsubmit="return checkForm()">
	         ...
	         <div  class="my-3">
	            ...
	            <textarea  class="form-control"    id="bcontent"  
	            		   name="bcontent"  ><%=bcontent %></textarea>
	         </div>
	         <div  class="my-3  text-end"> 
	            ...
	            <button type="submit"  class="btn btn-primary"  title="글수정">수정하기</button>
	         </div>
	      </form> 
