## 🚀 손예진 | 실전형 풀스택 개발자 포트폴리오

> 완벽보다 완성을.
> **기획부터 배포까지, 사용자 흐름을 이해하고 끝까지 구현하는 개발자입니다.**

기능을 단순히 구현하는 것보다
**왜 필요한 기능인지, 데이터가 어떻게 흐르는지**를 이해하는 것을 중요하게 생각합니다.

CS 기반의 문제 해결과 협업 경험을 바탕으로
프로젝트를 진행하며 배우고, 적용하고, 개선해왔습니다.
...
- **6개월차**
  - Python → 데이터 처리 및 분석
  - Django → MTV 패턴을 활용한 웹 애플리케이션 구현
  - 분석 프로젝트 → Django 기반 데이터 분석 대시보드 구현
  - Flutter → 크로스 플랫폼 앱 개발 기초
