...
public class List001 {
	public static void main(String[] args) {
		...
		List<String> list3 = new ArrayList<String>(); //<자료형> - 제네릭스/리스트에 넣을 자료형제한
		...
		List<String> list4 = new ArrayList<>(); // 받는쪽에 제레릭스 작성시 뒤쪽 생략가능
		list4.add("apple");
		list4.add("banana");
		list4.add("coconut");
		list4.add("mango");
...
※ 배열) 같은타입만 묶어서 저장가능, 배열생성시 크기를 지정해서 사용 -> 추후 변경 불가능
