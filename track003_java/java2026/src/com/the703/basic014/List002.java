...
//	public UserDto() { this.no = ++cnt;  }  // 유저번호 = 값; 값 1개 증가 -넣기
...
public class List002 {
	public static void main(String[] args) {
		...
		System.out.println("INFO1" + (0+1) + ":" + dto.getNo() + "/" + dto.getEmail());
		
		int cnt=0;
		for(UserDto a: users ) { System.out.println("INFO" + (cnt++ + 1) + ":" + a.getNo() + "/" + a.getEmail());  }
