...
1. S : 한 클래스는 하나만(한가지 일만 / 쿠키반죽-반죽만, 쿠키굽기-굽기만)
...
//3. L : 리스코프 치환 ( 어떤쿠키든 Cookie 인터페이스로 바꿔써서 문제없음 부모 = 자식 )
class CookieFactory { // Cookie cookie  각종 쿠키종류
	public void makeCookie(Cookie cookie) { cookie.make(); }	// 어떤쿠키든 여기서 만들 수 있음
}

//4. I : interface - 너무 많은 기능을 강요하지말것 / 꼭 필요한 기능(절차)
interface SimpleCookie { void make1();  /* void make2(); void make3(); */ }

//5. D : 의존역전 - 어떤 쿠키든 가게에서 팔수있음
...
public class SolidBasic {
	public static void main(String[] args) {
		...
		System.out.println("\n2. o: 개방폐쇄(레시피 추가) + l : 리스코프(공장-어떤쿠키든 굽기 가능) 치환");
