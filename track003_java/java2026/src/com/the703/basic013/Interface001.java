...
interface Animal2{
	...
	// sf : ststic final - Animal2.company (클래스 변수) method area, new X, this 각각Xs
...
//		company="Kakao";	The final field Animal2.company cannot be assigned
		System.out.println( Animal2.company + " 랍스타... 냠 " );
	}
}
class Pig implements Animal2{
	@Override public void eat() { 
		System.out.println( Animal2.company + " degi... 냠 " );
	}
}
