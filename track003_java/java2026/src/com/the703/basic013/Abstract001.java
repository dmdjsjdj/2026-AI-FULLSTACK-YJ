...
class Cat extends Animal{
	@Override void eat()   { System.out.println(super.name + " 고양이 냠");  }
	@Override void sleep() { System.out.println(super.name + " 고양이 냑");  }
	@Override void poo()   { System.out.println(super.name + " 고양이 냥");  }
}
class Dog extends Animal{
	@Override void eat()   { System.out.println(super.name + " 강아지 먐");  }
	@Override void sleep() { System.out.println(super.name + " 강아지 먁");  }
	@Override void poo()   { System.out.println(super.name + " 강아지 먕");  }
}
