	...
	public static void main(String[] args) {	
		try {
			...
			String api = "https://openapi.naver.com/v1/search/book.xml?query="
							+ URLEncoder.encode("법정스님", "UTF-8");  //## 검색어
			URL url = new URL(api);
...
//			Client ID 		NAxRVzTb26pJWpan8B05
//			Client Secret	B7zCEd7XY2
			conn.setRequestMethod("GET");
			conn.setRequestProperty("X-Naver-Client-Id"    , "NAxRVzTb26pJWpan8B05");
			conn.setRequestProperty("X-Naver-Client-Secret", "B7zCEd7XY2");
