...
class ZooKeeper1 {
	void show(Animal1 a) {
		a.sound();
		if(a instanceof Dog1) { ((Dog1)a).playFetch(); }
		else if(a instanceof Cat1) { ((Cat1)a).scratch(); }
		else if(a instanceof Bird1) { ((Bird1)a).fly(); }
	}
}
