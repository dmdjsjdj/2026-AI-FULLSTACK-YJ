...
/* 
Q1,2. 상속도를 그리시오. / 상속도에서 각 객체에서 사용할 수 있는 멤버변수와 멤버함수를 적으시오.
	Object	#3{							   }#4
 	 ↑
...
public class Repeat003_oop {
	public static void main(String[] args) {
		...
		//			     3번지 			(비어잇음)			  {money=10/toString}
		
//		 Son s3 = (Son) new Papa();  //  ↑ 자식 생성자를 담은게 없어서
	 /* 	 ↑
		  Exception in thread "main" java.lang.ClassCastException: class com.the703.basic013_ex.Papa 
		  cannot be cast to class com.the703.basic013_ex.Son (com.the703.basic013_ex.Papa 
		  and com.the703.basic013_ex.Son are in unnamed module of loader 'app')
		  at com.the703.basic013_ex.Repeat003_oop.main(Repeat003_oop.java:50)
	  */
		
		// Q6. Papa p4 = new Son(); 실행 시 메모리 구조와 출력 결과를 설명하시오.
		// Papa p4 = 			(비어잇음)			  {money=10/toString}
		...
		// Q8 오버로딩/오버라이딩이란?
		//오버로딩  : 메서드의 이름을 같게, 알규먼트 자료형과 갯수를 다르게 구분 / 비슷한기능
