...
class Farm {
	...
	static void numPlus() { FarmNum++; /* this.age++; */ } //클래스.메서드 - method area - static / this. 사용불가
...
public class Class005 {
	public static void main(String[] args) {
		...
		dog.name = "양갱"; dog.age = 5; /* dog.numPlus(); */	Farm.numPlus(); dog.show();
	}
}
/*
1. 초기화순서
...
/* [RUNTIME DATA AREA]
------------------------------------------------------------------------------
[METHOD:정보, static, final]	 Farm.class(설계도)	,	Class005.class#1)
	Farm.FarmName="(주) 동물농장";  Farm.FarmNum=2;  Farm.FarmBoss="신동엽";  Farm.numPlus()
------------------------------------------------------------------------------
[HEAP:동적]            					|  [STACK:지역]
2번지: {name="양갱", age=5}					←   dog(2번지)
