...
export default function JoinPage(){
    ...
    const { me, isLoading, error, signUpDone, isEmailAvailable, checkEmailLoading, isNicknameAvailable,
            checkNicknameLoading,  } = useSelector((state) => state.user);
    ...
    <div className="container mt-4">
        ...
        {isNicknameAvailable === true && (
            <div className="text-success mb-2">사용 가능한 닉네임입니다.</div>
        )}
        {isNicknameAvailable === false && (
            <div className="text-danger mb-2">이미 사용 중인 닉네임입니다.</div>
        )}
