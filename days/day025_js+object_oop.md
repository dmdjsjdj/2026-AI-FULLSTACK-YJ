...
public class Abstract001 {
   public static void main(String[] args) {
      ...
      Animal ani = new Animal();   Q3. 이코드에서 오류나는 이유는? 구현부가 없어서 new 사용불가
...
interface Animal2{
   String company="(주) thejoa";    //Q7.  interface에서의 멤버변수에 붙는 키워드는? sf static final
   void eat();     //Q8.  interface에서의 멤버함수에 붙는 키워드는?  a abstract
}
class Saram implements Animal2{ 
   @Override public void eat() { 
      company="kakao";  //interface는 final - 재선언 불가 >>>>>> Q6
