 ...
 * reducers/user.js
 * ----------------------
 * 사용자 관련 상태( user state ) 를 관리하는 리듀셔
...
export const LOAD_USERS_REQUEST = 'LOAD_USERS_REQUEST'; // 사용자목록
export const LOAD_USERS_SUCCESS = 'LOAD_USERS_SUCCESS'; // 사용자목록 성공
export const LOAD_USERS_FAILURE = 'LOAD_USERS_FAILURE'; // 사용자목록 실패

export const UPDATE_NICKNAME_REQUEST = 'UPDATE_NICKNAME_REQUEST'; // 닉네임 수정
export const UPDATE_NICKNAME_SUCCESS = 'UPDATE_NICKNAME_SUCCESS'; // 닉네임 성공
export const UPDATE_NICKNAME_FAILURE = 'UPDATE_NICKNAME_FAILURE'; // 닉네임 실패
...
export const initialState={
    ...
    users: [],  // 전체 사용자목록  [ { id, email, nickname } ]
